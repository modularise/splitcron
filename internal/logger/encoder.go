...
func NewSplitcronEncoder() zapcore.Encoder {
	return splitcronEncoder{
		Encoder:       zapcore.NewConsoleEncoder(fieldEncoderConfig),
		EncoderConfig: externalEncoderConfig,
	}
}

type splitcronEncoder struct {
	zapcore.Encoder
	zapcore.EncoderConfig
}

func (c splitcronEncoder) EncodeEntry(ent zapcore.Entry, fields []zapcore.Field) (*buffer.Buffer, error) {
	line := pool.Get()
